...
type FrameRequest struct {
	Type      string          `json:"type,omitempty"` // "request" (default), "response", "cancel"
...
type FrameResponse struct {
	...
	Event  string         `json:"event,omitempty"`  // "tool" | "meta" | "command_result"
	...
	// ClientReq is set when Event == "client_request".
